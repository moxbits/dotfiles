...
return packer.startup(function(use)
  ...
  use 'JoosepAlviste/nvim-ts-context-commentstring' -- Commenter plugin for jsx
  ...
  use "hrsh7th/cmp-nvim-lua" -- nvim API for lua source for nvim-cmp
